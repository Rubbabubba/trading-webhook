...
<div class='top'><div><div class='pill'>PAPER ONLY — LIVE INTRADAY CLOSED</div><h1>SPY Regime-Intraday Console</h1><div class='muted'>Generated {generated}. Auto-refresh 30 seconds. QQQ confirms regime; only SPY may produce entries.</div></div><div><a href='/dashboard/live'>Legacy live swing account</a> · <a href='/health'>System health</a></div></div>
