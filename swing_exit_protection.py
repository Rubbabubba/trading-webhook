...
SWING_EXIT_PROTECTION_MODULE_VERSION = "patch-639-broker-daily-goal-snapshot-cache-consistency-profit-path-pnl-source-sync"
...
def _call_runtime_fn(fn: Any, *args: Any, default: Any = None) -> Any:
    if not callable(fn):
        return default
    try:
        return fn(*args)
...
def build_exit_runtime_facts_from_plan(
    *,
    symbol: str,
    plan: dict | None,
    px: float,
