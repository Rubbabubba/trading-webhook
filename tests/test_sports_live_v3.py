...
import sqlite3
import pytest
from opportunity_lab.sports_live_books import Book, StreamBooks, auth_headers
...
from opportunity_lab.sports_live_sync import audit
from opportunity_lab.sports_live_timing import Latency, schema, signal, update_markouts, expire_markouts
from opportunity_lab.sports_live_v3 import record_ok, market_view, observation, probe_step, open_db
...
def test_paper_only_protocol_gate(tmp_path):
    with pytest.raises(ValueError,match='paper_only'):
        open_db(tmp_path,{'version':'sports_live_3.0','execution_enabled':True})
...
def test_runtime_offline_bootstrap_and_reports(tmp_path, monkeypatch):
    import hashlib
    import opportunity_lab.sports_live_v3 as live
    from opportunity_lab.sports_live_report import report
    ...
    config={'version':'sports_live_3.0','execution_enabled':False,'games':[c],
