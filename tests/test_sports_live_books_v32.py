...
import sqlite3
import pytest
from opportunity_lab.sports_live_books_v32 import Book, StreamBooks, auth_headers
...
from opportunity_lab.sports_live_v32 import record_ok, market_view, observation, probe_step, open_db
...
def test_paper_only_protocol_gate(tmp_path):
    with pytest.raises(ValueError,match='paper_only'):
        open_db(tmp_path,{'version':'sports_live_3.2','execution_enabled':True})
...
def test_runtime_offline_bootstrap_and_reports(tmp_path, monkeypatch):
    import hashlib
    import opportunity_lab.sports_live_v32 as live
    from opportunity_lab.sports_live_report_v32 import report
    ...
    config={'version':'sports_live_3.2','execution_enabled':False,'games':[c],
