...
PATCH_VERSION = "patch-185-scanner-inflight-readiness"
...
def dashboard(request: Request):
    ...
    intraday_projection_blockers_text = ', '.join(_sl(intraday_projection.get('blockers'))) or 'none'
