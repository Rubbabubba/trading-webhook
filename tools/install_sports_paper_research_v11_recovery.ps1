...
$taskScript = Join-Path $PSScriptRoot 'start_sports_paper_research_v11.ps1'
...
Register-ScheduledTask -TaskName 'Codex Sports Paper Research V11 Recovery 20260912' -Action $taskAction -Trigger $taskTriggers -Principal $taskPrincipal -Settings $taskSettings -Description 'Recover corrected prospective paper research only, bounded through September 18 at 12:00 UTC.' -Force | Select-Object TaskName,State
Start-ScheduledTask -TaskName 'Codex Sports Paper Research V11 Recovery 20260912'
