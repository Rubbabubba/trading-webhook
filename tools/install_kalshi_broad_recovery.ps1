...
$taskScript = Join-Path $PSScriptRoot 'start_kalshi_broad.ps1'
...
Register-ScheduledTask -TaskName 'Codex Kalshi Broad Paper Recovery 20260914' -Action $taskAction -Trigger $taskTriggers -Principal $taskPrincipal -Settings $taskSettings -Description 'Recover corrected prospective paper research only, bounded through September 21 at 14:30 UTC.' -Force | Select-Object TaskName,State
Start-ScheduledTask -TaskName 'Codex Kalshi Broad Paper Recovery 20260914'
