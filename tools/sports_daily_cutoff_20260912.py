"""Read-only daily accounting; writes only September 12 report artifacts."""
import json
import sqlite3
...
OUT = Path('sports_paper/daily_email/2026-09-12')
OUT.mkdir(parents=True, exist_ok=True)
START = datetime(2026, 9, 12, tzinfo=ZoneInfo('America/Chicago')).astimezone(timezone.utc)
