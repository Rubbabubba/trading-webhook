...
$taskScript = Join-Path $PSScriptRoot 'start_sports_market_lab_v12.ps1'
...
Register-ScheduledTask -TaskName 'Codex Sports Market Lab V12 Recovery 20260912' -Action $taskAction -Trigger $taskTriggers -Principal $taskPrincipal -Settings $taskSettings -Description 'Recover authorized quote probes only, bounded through September 18 at 12:00 UTC.' -Force | Select-Object TaskName,State
Start-ScheduledTask -TaskName 'Codex Sports Market Lab V12 Recovery 20260912'
