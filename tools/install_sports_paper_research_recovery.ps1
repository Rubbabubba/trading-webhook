...
$taskScript = Join-Path $PSScriptRoot 'start_sports_paper_research.ps1'
...
Register-ScheduledTask -TaskName 'Codex Sports Paper Research Recovery 20260910' -Action $taskAction -Trigger $taskTriggers -Principal $taskPrincipal -Settings $taskSettings -Description 'Recover authorized paper simulation only, bounded through September 18 at 12:00 UTC.' -Force | Select-Object TaskName,State
Start-ScheduledTask -TaskName 'Codex Sports Paper Research Recovery 20260910'
