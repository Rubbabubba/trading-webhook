...
def run(manifest, output, once=False):
    ...
    def reports():
        from .sports_live_report_v33 import report
...
if __name__=='__main__':
    p=argparse.ArgumentParser();p.add_argument('--manifest',default='configs/sports_live_v33_20260912/manifest.json')
    p.add_argument('--output',default='sports_paper/live_v33_20260912');p.add_argument('--once',action='store_true')
