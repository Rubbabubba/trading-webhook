...
CANDIDATES = (
    ...
    Candidate("matched_betting", 7, "Matched betting/promotions", "promotion", "manual_assist", "multi_venue", ("promotion_terms", "hedge_venue"), "active_manual_research", "Bonus-bet and deposit-match conversion calculator active; Texas availability, account eligibility, and exact terms remain mandatory blockers."),
