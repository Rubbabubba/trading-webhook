...
VERSION = 'broad_paper_1.0'
OUTPUT = Path('sports_paper/broad_20260914')
MANIFEST = Path('configs/kalshi_broad_20260914/manifest.json')
    ...
    try:
        while utcnow()<end:
            ...
            try:
                ...
                for series in ('KXMLBGAME','KXNFLGAME'):
                ...
                try:
                    ...
                    for side in ('yes','no'):
                        ...
                        for arm in ('scheduled_control','reversal'):
                            ...
                            elif sum(p['state'] in ('staged','open','exit_staged') for p in trials.values())>=12:reason='global_12_position_cap'
                            ...
                            for h in (300,900):
                                if sum(p['state'] in ('staged','open','exit_staged') for p in trials.values())>=12:break
